        ...
        <section id="work" class="padding--offset content--padding">
          ...
          <div class="grid-x grid-padding-x">
            <div class="large-12 cell" style="text-align:center;">
              <a href="https://dribbble.com/trice" title="Follow me on Dribbble" class="white button--outline"><img src="assets/img/icon-dribbble.svg" style="width: 48px; padding: 12px 12px 12px 0;">More work at Dribbble</a>
            </div>
          </div>
        </section>
